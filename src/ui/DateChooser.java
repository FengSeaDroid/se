...
public class DateChooser extends JPanel {
	...
	private JPanel monthPanel;//month panel
	private JP1 jp1;//constructed by four panel  
	private JP2 jp2;
	private JP3 jp3;
	private JP4 jp4;
	...
	private class JP2 extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			g.setFont(font);
			g.drawString(" Sun       Mon      Tue       Wed      Thur       Fri        Sat", 5, 10);
	...
	private class JP4 extends JPanel {
		...
		public JP4() {
			...
			jl.setToolTipText("Click to choose today");
